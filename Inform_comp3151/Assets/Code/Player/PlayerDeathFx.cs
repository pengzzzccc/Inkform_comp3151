...
/// 必须挂在 Player 根物体上：LifeBus.Died 带的 victim 是碰撞体所在的根物体，
/// 挪到 Visual 子物体上的话 victim != gameObject 就永远不成立，认领不到自己的死。
/// 渲染器则在 Visual 子物体上（那层要做挤压拉伸），所以往下找。
/// </summary>
public class PlayerDeathFx : MonoBehaviour
{
    ...
    {
        if (victim != gameObject || sprite == null) return;
