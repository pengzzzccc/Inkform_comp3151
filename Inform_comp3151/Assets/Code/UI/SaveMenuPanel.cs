...
{
    /// <summary>
    /// Save menu sheet: three save slots (each shows "No Records" for now) with left/right arrows and
    /// a Back button. Saving is a stub — slots always display "No Records" and any slot starts a fresh
    /// run via UIManager.StartNewGame.
    ///
    ...
    public class SaveMenuPanel : BasePanel
    {
        ...
        private void OnBack() => UIManager.Instance.Close<SaveMenuPanel>();
